...
class ServiceMetricsBufferTestDataGenerator {
  ...
  addData(serviceMetricsEmitter) {
    ...
    self.addMethodMetrics(serviceMetricsEmitter,
      ServiceMetricMethods.GET_ITEM_RESOURCE);
  ...
  addMethodMetrics(serviceMetricsEmitter, method) {
    const self = this;
    self.addMethodMetricName(serviceMetricsEmitter, method,
      ServiceMetricNames.INTERNAL_SERVER_EXCEPTION_RESPONSES,
      ServiceMetricsBufferTestDataGenerator.getRandomInt(5, 10));
    self.addMethodMetricName(serviceMetricsEmitter, method,
      ServiceMetricNames.FORBIDDEN_RESPONSES,
      ServiceMetricsBufferTestDataGenerator.getRandomInt(10, 20));
    self.addMethodMetricName(serviceMetricsEmitter, method,
      ServiceMetricNames.UNAUTHORIZED_RESPONSES,
      ServiceMetricsBufferTestDataGenerator.getRandomInt(20, 30));
    self.addMethodMetricName(serviceMetricsEmitter, method,
      ServiceMetricNames.BAD_REQUEST_RESPONSES,
      ServiceMetricsBufferTestDataGenerator.getRandomInt(5, 10));
    self.addMethodMetricName(serviceMetricsEmitter, method,
      ServiceMetricNames.OK_RESPONSES,
      ServiceMetricsBufferTestDataGenerator.getRandomInt(700, 1000));
    self.addMethodMetricName(serviceMetricsEmitter, method,
      ServiceMetricNames.NOT_FOUND_RESPONSES,
      ServiceMetricsBufferTestDataGenerator.getRandomInt(10, 20));
  }
